...
const ProductCard = ({item}) => {
  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center basis-1/3 gap-y-2 md:basis-1/5 w-1/4 p-2 border border-black rounded-lg">
        <Image src={productObject.imageUrl ? productObject.imageUrl : clothesIcon} height={100} width={50} alt={productObject.name} className="mx-auto h-1/2 w-full max-h-1/2"/>
        ...
        <div className="flex flex-col flex-wrap w-full gap-y-2">
          <button className="border border-green-500 bg-green-300 rounded-md p-1" onClick={() => {onSubmit()}}>update</button>
